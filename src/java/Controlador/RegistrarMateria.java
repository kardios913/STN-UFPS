...
public class RegistrarMateria extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       int  codigo= Integer.parseInt(request.getParameter("codMateria"));
       String nombre= request.getParameter("nomMateria");
       boolean Registro= new Negocio.STN().RegistrarMateria(codigo,nombre);
       if(Registro){
