 ...
 * @author KRLOS
 */
@WebServlet(name = "EliminarEstudianteNota", urlPatterns = {"/EliminarEstudianteNota.do"})
public class EliminarEstudianteNota extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean eliminar = new Negocio.STN().ELiminarEstudianteMateriaCascada(codMat,codEst);
                if (eliminar) {
                    request.getRequestDispatcher("./Vista/FormListarMateria.jsp").forward(request, response);
                    System.out.println("Estudiante Eliminada!!");
                } else {
