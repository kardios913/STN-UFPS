...
public class GuardarEstudiante extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int codMateria = Integer.parseInt(request.getParameter("codMateria"));
        int codigo = Integer.parseInt(request.getParameter("codEstudiante"));
        String nombre = request.getParameter("nomEstudiante");
        String email = request.getParameter("emailEstudiante");
        boolean iem = new Negocio.STN().insertarEstudianteMateria(codMateria, codigo, nombre, email);
        if (iem) {
            ...
            System.out.println("No se registro el Estudiante: " + codigo + "en la Materia: " + codMateria);
